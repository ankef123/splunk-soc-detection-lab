Для эмитации этой атаки, на kali:
1) Подготавливаем все необходимые инструменты
2) Теперь нам необходимо воспользоваться любым из написанных заранее нами правил для suricata
# 1. Атака
Попробуем получить доступ к админке с kali(внешний ip):

воспользуемся обычным браузером и перейдем по ссылке "http://172.16.20.10/admin/"
