Для имитации этой атаки воспользуемся подключением по RDP к WS. Будем использовать `rex`, чтобы не усложнять разбор XML в учебной лаборатории.
...
# 6. Investigation
Поскольку инфраструктура лаборатории ограничена, опишу свои действия простыми словами:
