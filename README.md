...
| **Suricata IPS** | `ens3` → IPS outside/data → `no IP`  <br> `ens4` → IPS inside/data → `no IP`  <br> `ens5` → MGMT → `10.10.20.30/24` | `10.10.20.1` | Inline IPS with dedicated management interface |
...
| **Admin Workstation** | `e0` → MGMT → `10.10.20.20/24`  <br> `e1` → OOB-ACCESS → `192.168.216.20/24` | `10.10.20.1` | Windows admin workstation / jump host |
